...
namespace ATTSystems.SFA.DAL
{
    public partial class DataContext : DBCoreCtx
    {
        ...
        public virtual DbSet<VisitorRegistrationAudit> VisitorRegistrationAudits { get; set; }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<UsersAudit>(entity =>
            {
                entity.HasKey(e => e.Id).HasName("PK_dbo.UsersAudit");

                entity.ToTable("UsersAudit");
                ...
                entity.Property(e => e.EmailAudit).HasMaxLength(256);
                ...
                entity.Property(e => e.UserName)
                    .IsRequired()
                    .HasMaxLength(256);
                entity.Property(e => e.UserNameAudit)
                    .IsRequired()
                    .HasMaxLength(256);
            });

            modelBuilder.Entity<VisitorRegistrationAudit>(entity =>
            {
                entity
                    .HasNoKey()
                    .ToTable("VisitorRegistrationAudit");
